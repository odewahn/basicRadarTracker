<?php include "../config.php"; ?>
 ...
 <link id="data_source"
       ...
       href="<? echo $config['data_source']['people']; ?>"
...
<table id="frame">
   <tr>
      <td id="sidebar">
         <p>
         <div ex:role="facet" ex:expression=".expertise" ex:facetLabel="Expertise"></div>
      </td>
      <td id="content">
            ...
            <div class="item" ex:role="exhibit-lens">
                  ...
                  <table cellpadding="10" width=100%>
                     ...
                     <td>
                        ...
                        <div><span><b>Title</b>:<span ex:content=".title"></span></div>
                        <div><span><b>Key tag</b>:<span ex:content=".keyTag"></span></div>
                        <div><span><b>Tags</b>:<span ex:content=".tags"></span></div>
                        <div><span><b>Comments</b>:<span ex:content=".comments"></span></div>
                     </td>
                     </tr>
                  </table>
            </div>
