<?php include "../config.php"; ?>
 ...
 <link rel="exhibit/data"
       ...
       href="<?php echo $config['data_source']['projects']; ?>"
...
<table id="frame">
   <tr>
      <td id="sidebar">
         <p>
         <div ex:role="facet" ex:expression=".expertise" ex:facetLabel="Category"></div>
      </td>
      <td id="content">
         ...
         <div id="exhibit-view-panel">
            ...
            <div class="item" ex:role="exhibit-lens">
                  ...
                  <table cellpadding="10" width=100%>
                     <tr>
                     <td width="1">
                        <img ex:src-content=".imageURL" width="100" /></td>
                     </td>
                     <td>
                        <a target="_blank" ex:href-content=".projectURL"><span ex:content=".label"/></a>
...
<!--
            <div ex:role="exhibit-view"
                ...
                ex:label="Table"
                ex:columns=".label, .imageURL .title, .orbit, .tags, .orgURL, .comments"
                ex:columnLabels="Name, Picture, Title, Orbit, Tags, Organization, Comments"
                ex:sortColumns= 1
